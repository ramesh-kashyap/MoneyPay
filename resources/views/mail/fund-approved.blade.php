                          ...
                          <table width="100%" cellpadding="0" cellspacing="0"
                              ...
                              <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                  <td class="content-block"
                                      style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                      valign="top">
                                   We are happy to announce that Your fund Request of &#8377; {{ $view_message['amount'] }} and ID :- {{ $view_message['username'] }} is successfully Approved by Admin and successfully credited into your executive partner wallet you can use this to activation of ids or Upgrade ids
