      ...
      <td class="container" width="600"
          ...
          <div class="content"
              ...
              <table class="main" width="100%" cellpadding="0" cellspacing="0"
                  ...
                  <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                      <td class=""
                          style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size:32px; vertical-align: top; color: #fff; font-weight: 500; text-align: center; display: block; border-radius: 3px 3px 0 0; background-color: #fff; margin: 0;text-shadow: 2px 2px #0100c9;"
                          align="center" bgcolor="#71b6f9" valign="top">
                        <p style="text-shadow: 2px 2px #0100c9;"><img src="https://nexopartner.com/upnl/images/logo-icon.png" style="width:200px"></p>
                      </td>
                  </tr>
                  <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0"
                              ...
                              <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                  <td class="content-block"
                                      style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                      valign="top">
                                     We are happy to have you onboard we are glad to announce that you have successfully registered with Nexo Partners Executive Referral Program we wish all the very best for bringing change into your life with help of us
                              ...
                              <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                  <td class="content-block"
                                      style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                      valign="top">
                                     MANAGEMENT TEAM, NEXO CORPORATION.
                                  </td>
                              </tr>
                          </table>
                      </td>
