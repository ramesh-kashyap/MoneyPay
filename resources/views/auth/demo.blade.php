        ...
        <div class="login-area">
            <div class="login-area-inner">
                <div class="text-center">
                    ...
                    <h6 class="title mb-2">Login Now</h6>
                </div>
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="mt-5">
                        <button type="submit"  class="cmn-btn rounded-0 w-100">Login Now</button>
                        <div class="mt-20 d-flex flex-wrap justify-content-between">
                                                            <p>Haven't an account? <a href="{{route('register')}}" class="text--base">Create an account</a></p>
                                                        <p><a href="{{route('forgot-password')}}" class="text--base">Forget password?</a></p>
                        </div>
                    </div>
                </form>
            </div>
