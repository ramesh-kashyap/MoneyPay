        ...
        <div class="login-area">
            <div class="login-area-inner">
                <div class="text-center">
                    ...
                    <h6 class="title mb-2">Reset Your Password</h6>
                </div>
                ...
                >
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="" name="password" required placeholder="enter password">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-20 d-flex flex-wrap justify-content-between">
                                                            <p>Haven't an account? <a href="{{route('login')}}" class="text--base">Create an account</a></p>
                        </div>
                    </div>
                </form>
            </div>
