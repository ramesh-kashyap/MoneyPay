        ...
        <section class="bg-softBg1 stp-30 sbp-30 overflow-hidden">
            <div class="container">
                <div class="flex justify-between items-end gap-6 max-lg:flex-col max-lg:items-start">
                    ...
                    <p class="text-bodyText max-w-[500px]"> Your dependable guide to achieving freedom from manual HR
                        work and building that perfect workplace you have always aspired to build. Your dependable guide
                ...
                <div class="flex justify-center items-center">
                    <div class="flex justify-center items-center max-xxl:overflow-hidden">
                        <div class="max-w-[700px] text-center flex justify-center items-center flex-col">
                            ...
                            <p class="text-bodyText wow animate__animated animate__fadeInUp"> Explore our platform with
                                ease! Sign up, select your industry, and seamlessly integrate our tailored payment
                                solutions. </p>
                        </div>
                    </div>
                </div>
                <div class="flex justify-between items-center gap-6 md:gap-4 lg:gap-6 stp-15 relative max-md:flex-col">
        ...
        <div class="bg-p1 pt-15 overflow-hidden">
            <div
                ...
                <div
                    ...
                    <p class="text-lg font-medium underline wow animate__animated animate__fadeInUp"> Experience AccuPay
                    </p>
                    <h1 class="display-4 pb-6 pt-4 wow animate__animated animate__fadeInDown"> We’ve got everything you
                        need? </h1>
                    <p class="pb-8 wow animate__animated animate__fadeInUp"> We save you from all that boring paperwork!
                        From global hiring, to instant payments, and taxes, we’ve got your back. </p><a href="/contact"
            ...
            <div class="container">
                <div class="flex justify-center items-center">
                    <div class="flex justify-center items-center max-w-[600px] flex-col">
                        ...
                        <p class="text-bodyText text-center pt-6"> hile we go so much further and do so much more for
                            clients, these core services help provide a framework to provide you with relevant, reliable
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4">
                        <div
                            ...
                            <div
                                ...
                                <h4 class="heading-4 pb-5 pt-8">Accounting Services</h4>
                            </a>
                            <p class="text-bodyText lg:pr-4">Efficient payroll management is at the heart of our
                                services. Experience seamless payroll processing,</p>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 md:col-span-4">
                        <div
                            ...
                            <div
                                ...
                                <h4 class="heading-4 pb-5 pt-8">Payroll Processing</h4>
                            </a>
                            <p class="text-bodyText lg:pr-4">Efficient payroll management is at the heart of our
                                services. Experience seamless payroll processing,</p>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4">
                        <div
                            ...
                            <div
                                ...
                                <h4 class="heading-4 pb-5 pt-8">Taxation services</h4>
                            </a>
                            <p class="text-bodyText lg:pr-4">Efficient payroll management is at the heart of our
                                services. Experience seamless payroll processing,</p>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4">
                        <div
                            ...
                            <div
                                ...
                                <h4 class="heading-4 pb-5 pt-8">Real Estate Services</h4>
                            </a>
                            <p class="text-bodyText lg:pr-4">Efficient payroll management is at the heart of our
                                services. Experience seamless payroll processing,</p>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4">
                        <div
                            ...
                            <div
                                ...
                                <h4 class="heading-4 pb-5 pt-8">Healthcare Services</h4>
                            </a>
                            <p class="text-bodyText lg:pr-4">Efficient payroll management is at the heart of our
                                services. Experience seamless payroll processing,</p>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4">
                        <div
                            ...
                            <div
                                ...
                                <h4 class="heading-4 pb-5 pt-8">Dentist Services</h4>
                            </a>
                            <p class="text-bodyText lg:pr-4">Efficient payroll management is at the heart of our
                                services. Experience seamless payroll processing,</p>
                        </div>
